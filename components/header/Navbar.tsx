      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4 ltr:space-x-4 rtl:space-x-reverse relative">
            ...
            {/* Wishlist */}
            {loading ? <IconSkeleton /> : <WishlistIcon />}

            {/* Shopping Cart */}
            {loading ? <IconSkeleton /> : <ShoppingCartIcon />}
...
//   const IconSkeleton = ({ className }: { className?: string }) => (
//     <div
//       className={`w-8 h-8 rounded-full bg-gray-700 animate-pulse ${className || ""}`}
//       aria-hidden="true"
//     />
//   );
...
//             {/* User Dropdown */}
//             {loading ? (
//               <div className="w-28 h-8 rounded-md bg-gray-700 animate-pulse" />
//             ) : (
//               <UserDropdown />
//             )}
