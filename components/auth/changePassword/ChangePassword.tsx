          ...
          <div className="relative hidden lg:block">
            ...
            <div className="mt-6 text-center">
              <h3 className="text-xl font-bold text-gray-800 mb-2">
                {translate?.pages.changePassword.securityTips || "نصائح أمنية"}
              </h3>
              <ul className="text-gray-600 text-sm space-y-1 text-right">
                <li>• استخدام مزيج من الأحرف والأرقام والرموز</li>
                <li>• تجنب استخدام كلمات مرور سهلة التخمين</li>
                <li>• تغيير كلمة المرور بشكل دوري</li>
                <li>• عدم استخدام نفس كلمة المرور لمواقع متعددة</li>
              </ul>
            </div>
          </div>
        </div>
