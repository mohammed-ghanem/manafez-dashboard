...
import { PermissionGroup } from "@/store/permissions/types";
...
const GroupPermission = ({ group, selected, setSelected }: Props) => {
  const [open, setOpen] = useState(true);

  const toggleAllGroup = () => {
    const ids = group.controls.map((p) => p.id);
